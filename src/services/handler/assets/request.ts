...
class HyperCloudRequest {
    private readonly _request: InitializedRequest;
    private readonly _req: http2.Http2ServerRequest;
    private _params = {} as Record<string, string>;
    /**The locale of the client. Example: `en-PS`; */
    private _locale: string;
    private _lang: string;

    private _user = Object.seal({
