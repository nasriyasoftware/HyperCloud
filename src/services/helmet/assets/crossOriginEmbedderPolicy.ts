import { CrossOriginEmbedderPolicyOptions } from "../../../docs/docs";
import helpers from "../../../utils/helpers";

class CrossOriginEmbedderPolicy {
    static readonly #_possiblePolicies = ["unsafe-none", "require-corp", "credentialless"];

    static validate(options?: CrossOriginEmbedderPolicyOptions | false) {
