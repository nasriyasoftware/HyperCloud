...
declare class HyperCloudResponse {
    ...
    readonly pages: {
         ...
         */
        notFound: (options?: NotFoundResponseOptions) => void;
        /**
         ...
         */
        unauthorized: (options?: ForbiddenAndUnauthorizedOptions) => void;
        /**
         ...
         * @param {ForbiddenAndUnauthorizedOptions} options 
         */
        forbidden: (options?: ForbiddenAndUnauthorizedOptions) => void;
        /**
         ...
         */
        serverError: (options?: ServerErrorOptions) => void;
    }
     ...
     */
    redirect(url: string, code?: RedirectCode): void;
     ...
     */
    send(data: string | object | Buffer, contentType?: MimeType): void;
     ...
     */
    json(data: object | Array<any>): void;
    ...
    /** Description for the `pipe` method */
    ...
    /** Number of times ```writable.uncork()``` needs to be called. */
    ...
    /** When using implicit headers, this property controls the status code. */
