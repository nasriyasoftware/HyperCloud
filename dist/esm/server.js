...
class HyperCloudServer {
    ...
    constructor(userOptions, addOpt) {
        ...
        try {
            if (helpers.is.undefined(userOptions)) {
                return;
            }
            if (!helpers.is.realObject(userOptions)) {
            ...
            if ('secure' in options) {
                ...
                if (options.secure === true) {
                    ...
                    if ('ssl' in options) {
                        if (helpers.is.undefined(options.ssl) || !helpers.is.realObject(options.ssl)) {
                            ...
                            case 'credentials':
                                {
                                    if ('credentials' in options) {
                                        if (helpers.is.undefined(options.ssl.credentials) || !helpers.is.realObject(options.ssl.credentials)) {
                                ...
                                break;
                            case 'letsEncrypt': {
                                if (helpers.is.undefined(options.ssl.letsEncrypt) || !helpers.is.realObject(options.ssl.letsEncrypt)) {
                                ...
                                if ('email' in options.ssl.letsEncrypt && !helpers.is.undefined(options.ssl.letsEncrypt)) {
                                    if (!helpers.is.validString(options.ssl.letsEncrypt.email)) {
                                    ...
                                    if (!helpers.validate.email(options.ssl.letsEncrypt.email)) {
                                ...
                                if ('domains' in options.ssl.letsEncrypt && !helpers.is.undefined(options.ssl.letsEncrypt.domains)) {
                                    if (Array.isArray(options.ssl.letsEncrypt.domains)) {
                                        if (!helpers.validate.domains(options.ssl.letsEncrypt.domains)) {
                                ...
                                if ('certName' in options.ssl.letsEncrypt && !helpers.is.undefined(options.ssl.letsEncrypt.certName)) {
                                    if (!helpers.is.validString(options.ssl.letsEncrypt.certName)) {
            ...
            if ('proxy' in options && !helpers.is.undefined(options.proxy)) {
                if (!helpers.is.realObject(options.proxy)) {
            ...
            if ('languages' in options) {
                if (helpers.is.undefined(options.languages) || !helpers.is.realObject(options.languages)) {
            ...
            if ('handlers' in options && !helpers.is.undefined(options.handlers)) {
                if (!helpers.is.realObject(options.handlers)) {
                        ...
                        if (addOpt.saveConfig === true) {
                            const savePath = (() => {
                                if ('configPath' in addOpt) {
                                    if (helpers.is.undefined(addOpt.configPath) || !helpers.is.validString(addOpt.configPath)) {
    ...
    async listen(protocol) {
        try {
            ...
            const { port, callback } = (() => {
                if (helpers.is.undefined(protocol)) {
