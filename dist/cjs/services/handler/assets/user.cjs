    ...
    constructor(request, options) {
        ...
        if (!helpers_1.default.is.undefined(options) && helpers_1.default.is.realObject(options)) {
            try {
                ...
                helpers_1.default.printConsole('Unable to set the HyperCloud user on server request:');
        ...
        try {
            if (!helpers_1.default.is.undefined(options) && helpers_1.default.is.realObject(options)) {
                ...
                if ('locale' in options && options.locale !== undefined) {
                    if (helpers_1.default.validate.locale(options.locale)) {
                ...
                if ('currency' in options && options.currency !== undefined) {
                    if (helpers_1.default.validate.currency(options.currency)) {
            ...
            helpers_1.default.printConsole('Unable to set user preferences on server request:');
            helpers_1.default.printConsole(error);
            throw error;
        }
    }
...
exports.default = HyperCloudUser;
