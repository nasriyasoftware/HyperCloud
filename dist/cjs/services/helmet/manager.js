...
// Headers
const contentSecurityPolicy_1 = __importDefault(require("./assets/contentSecurityPolicy"));
const crossOriginEmbedderPolicy_1 = __importDefault(require("./assets/crossOriginEmbedderPolicy"));
const crossOriginOpenerPolicy_1 = __importDefault(require("./assets/crossOriginOpenerPolicy"));
const crossOriginResourcePolicy_1 = __importDefault(require("./assets/crossOriginResourcePolicy"));
const referrerPolicy_1 = __importDefault(require("./assets/referrerPolicy"));
const strictTransportSecurity_1 = __importDefault(require("./assets/strictTransportSecurity"));
const xDnsPrefetchControl_1 = __importDefault(require("./assets/xDnsPrefetchControl"));
const xFrameOptions_1 = __importDefault(require("./assets/xFrameOptions"));
const xPermittedCrossDomainPolicies_1 = __importDefault(require("./assets/xPermittedCrossDomainPolicies"));
class HelmetManager {
    #_server;
    #_defaults = {
        values: {
    ...
    config(options) {
        ...
        if (notUndefined && isRealObject && 'contentSecurityPolicy' in options) {
            this.#_values.contentSecurityPolicy = contentSecurityPolicy_1.default.validate(options.contentSecurityPolicy);
        }
        else {
            this.#_values.contentSecurityPolicy = this.#_defaults.values.contentSecurityPolicy;
        }
        ...
        if (notUndefined && isRealObject && 'crossOriginEmbedderPolicy' in options) {
            this.#_values.crossOriginEmbedderPolicy = crossOriginEmbedderPolicy_1.default.validate(options.crossOriginEmbedderPolicy) || '';
        }
        else {
            this.#_values.crossOriginEmbedderPolicy = this.#_defaults.values.crossOriginEmbedderPolicy;
        }
        ...
        if (notUndefined && isRealObject && 'crossOriginOpenerPolicy' in options) {
            this.#_values.crossOriginOpenerPolicy = crossOriginOpenerPolicy_1.default.validate(options.crossOriginOpenerPolicy) || '';
        }
        else {
            this.#_values.crossOriginOpenerPolicy = this.#_defaults.values.crossOriginOpenerPolicy;
        }
        ...
        if (notUndefined && isRealObject && 'crossOriginResourcePolicy' in options) {
            this.#_values.crossOriginResourcePolicy = crossOriginResourcePolicy_1.default.validate(options.crossOriginResourcePolicy) || '';
        }
        else {
            this.#_values.crossOriginResourcePolicy = this.#_defaults.values.crossOriginResourcePolicy;
        }
        ...
        if (notUndefined && isRealObject && 'referrerPolicy' in options) {
            this.#_values.referrerPolicy = referrerPolicy_1.default.validate(options.referrerPolicy) || '';
        }
        else {
            this.#_values.referrerPolicy = this.#_defaults.values.referrerPolicy;
        }
        ...
        if (notUndefined && isRealObject && 'strictTransportSecurity' in options) {
            this.#_values.strictTransportSecurity = strictTransportSecurity_1.default.validate(options.strictTransportSecurity) || '';
        }
        else {
            this.#_values.strictTransportSecurity = this.#_defaults.values.strictTransportSecurity;
        }
        ...
        if (notUndefined && isRealObject && 'xDnsPrefetchControl' in options) {
            this.#_values.xDnsPrefetchControl = xDnsPrefetchControl_1.default.validate(options.xDnsPrefetchControl) || '';
        }
        else {
            this.#_values.xDnsPrefetchControl = this.#_defaults.values.xDnsPrefetchControl;
        }
        ...
        if (notUndefined && isRealObject && 'xFrameOptions' in options) {
            this.#_values.xFrameOptions = xFrameOptions_1.default.validate(options.xFrameOptions) || '';
        }
        else {
            this.#_values.xFrameOptions = this.#_defaults.values.xFrameOptions;
        }
        ...
        if (notUndefined && isRealObject && 'xPermittedCrossDomainPolicies' in options) {
            this.#_values.xPermittedCrossDomainPolicies = xPermittedCrossDomainPolicies_1.default.validate(options.xPermittedCrossDomainPolicies) || '';
        }
        else {
            this.#_values.xPermittedCrossDomainPolicies = this.#_defaults.values.xPermittedCrossDomainPolicies;
        }
